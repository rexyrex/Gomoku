 ...
 */
public class AiVsAiState extends State{
    ...
    public AiVsAiState(GSM gsm, int aiWhiteDifficulty, int aiBlackDifficulty, int boardx, int boardy){
        super(gsm);
        //480 width
        //800 height
        ...
        //3=depth2
        //4=depth3
        System.out.println("BLACK DIFFICULTY : "+aiBlackDifficulty);
        System.out.println("WHITE DIFFICULTY : " +aiWhiteDifficulty);
    ...
    public void handleInput() {
        ...
        if(!isGameOver) {
            ...
            if (!isAiTurn) {
                int col;
                int row;
                int aiDifficulty =  getDifficultyFromColor(turn);
                if(aiDifficulty==0){
...
*/
    ...
    public int getDifficultyFromColor(int c) {
        if (c == 1){//white
            return aiWhiteDifficulty;
        } else {
            return aiBlackDifficulty;
        }
    }
